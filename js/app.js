...
function error(error) {
	switch(error.code) {
		...
		//var message = "User denied the request for Geolocation." //english
		var message = "ব্যবহারকারী ভৌগলিক অবস্থানের জন্য অনুরোধ অস্বীকার করেছেন ৷" //bangla
		  break;
...
function showPrayTimes(lat, long, prayTimes) {
	...
	var listBN = ['ফজর', 'সূর্যোদয়', 'যোহর/জুম্মা', 'আছর', 'সূর্যাস্ত', 'মাগরিব', 'এশা', 'মধ্যরাত'];
